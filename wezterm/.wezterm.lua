...
config.keys = {
  -- command: search in designated folders
  {
    ...
    action = act.SendString(
      "cd $(fd . -I --absolute-path --min-depth 0 --max-depth 4 -t d --exclude node_modules --exclude .git ~/projects ~/work ~/personal ~/vleete ~/sandbox ~/oss ~/arisanin ~/personal | fzf) && cl \r"
    ),
  },
